...
use rgpui_yororen_ui::component::{heading, label, switch};
...
impl TodoHeader {
    ...
    pub fn render(cx: &rgpui::App, compact_mode: bool) -> impl IntoElement {
        ...
        div()
            ...
            .justify_between()
            // Page title
            .child(heading(title).level(rgpui_yororen_ui::component::HeadingLevel::H1))
            .child(
                div()
                    .flex()
                    .items_center()
