...
pub fn refresh(window: &mut Window, cx: &mut rgpui::App) {
    let root = {
...
pub fn set_root_and_rescan(new_root: PathBuf, window: &mut Window, cx: &mut rgpui::App) {
...
pub fn prompt_for_root(window: &mut Window, cx: &mut rgpui::App) {
