...
use rgpui_yororen_ui::component::{ArcTreeNode, TreeCheckedState, TreeNode};
...
pub fn start_scan(root: PathBuf, window: &mut Window, cx: &mut rgpui::App) {
                    ...
                    .scoped({
                        ...
                        |scope| {
                            scope.spawn(async move {
                                *scanned = read_dir_nodes(&dir_for_bg);
                            })
                        }
                    })
                    .await;
