...
pub struct EmptyState {
    ...
    action: Option<rgpui::AnyElement>,
...
impl EmptyState {
    ...
    pub fn title(mut self, title: impl Into<rgpui::SharedString>) -> Self {
        self.title = Some(heading(title).level(HeadingLevel::H3));
        self
    }

    pub fn description(mut self, description: impl Into<rgpui::SharedString>) -> Self {
...
pub fn empty_state_primary_action(label_text: impl Into<rgpui::SharedString>) -> rgpui::AnyElement {
