...
type ChangeFn = Arc<dyn Fn(PathBuf, &mut rgpui::Window, &mut rgpui::App)>;
...
impl FilePathInput {
    ...
    where
        F: 'static + Fn(PathBuf, &mut rgpui::Window, &mut rgpui::App),
    {
                ...
                button(button_id)
                    ...
                    .on_click({
                        ...
                        move |_ev: &ClickEvent, window, cx| {
                            ...
                            let receiver = cx.prompt_for_paths(rgpui::PathPromptOptions {
                                files: true,
                                directories: true,
                                multiple: false,
                                prompt,
