...
type ChangeFn = Arc<dyn Fn(SharedString, &mut rgpui::Window, &mut App)>;
type SubmitFn = Arc<dyn Fn(SharedString, &mut rgpui::Window, &mut App)>;
...
impl RenderOnce for SearchInput {
    fn render(self, window: &mut rgpui::Window, cx: &mut App) -> impl IntoElement {
        ...
        let on_change_for_input = {
            ...
            move |value: SharedString, window: &mut rgpui::Window, cx: &mut App| {
