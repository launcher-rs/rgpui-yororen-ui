...
type ChangeFn = std::sync::Arc<dyn Fn(SharedString, &mut rgpui::Window, &mut rgpui::App)>;
...
impl KeybindingInput {
    ...
    where
        F: 'static + Fn(SharedString, &mut rgpui::Window, &mut rgpui::App),
    {
