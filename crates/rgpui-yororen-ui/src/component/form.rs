...
pub struct FormRow {
    ...
    label: SharedString,
    control: rgpui::AnyElement,

    help: Option<rgpui::AnyElement>,
    error: Option<rgpui::AnyElement>,

    label_width: rgpui::Pixels,
    label_color: Option<Hsla>,

    validation: Option<ValidationState>,
    validation_icon_size: Option<rgpui::Pixels>,
}
...
impl FormRow {
    ...
    pub fn label_width(mut self, width: rgpui::Pixels) -> Self {
    ...
    pub fn validation_icon_size(mut self, size: rgpui::Pixels) -> Self {
