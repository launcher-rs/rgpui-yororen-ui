...
type ChangeFn = Arc<dyn Fn(f64, &mut rgpui::Window, &mut rgpui::App)>;
...
impl NumberInput {
    ...
    where
        F: 'static + Fn(f64, &mut rgpui::Window, &mut rgpui::App),
    {
...
impl RenderOnce for NumberInput {
    fn render(self, window: &mut rgpui::Window, cx: &mut rgpui::App) -> impl IntoElement {
        ...
        let set_value = {
            ...
            move |next: f64, window: &mut rgpui::Window, cx: &mut rgpui::App| {
