...
type ChangeFn = Arc<dyn Fn(f32, &mut rgpui::Window, &mut rgpui::App)>;

struct TrackBoundsElement {
    bounds_state: rgpui::Entity<Bounds<rgpui::Pixels>>,
    inner: rgpui::AnyElement,
}
...
impl Slider {
    ...
    where
        F: 'static + Fn(f32, &mut rgpui::Window, &mut rgpui::App),
    {
