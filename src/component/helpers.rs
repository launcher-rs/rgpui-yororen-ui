...
pub struct InputStyle {
    ...
    pub border: rgpui::Hsla,
    /// The focus border color of the input.
    pub focus_border: rgpui::Hsla,
    /// The text color of the input.
    pub text_color: rgpui::Hsla,
}
...
pub fn compute_input_style(
    theme: &Theme,
    disabled: bool,
    bg_color: Option<rgpui::Hsla>,
    border_color: Option<rgpui::Hsla>,
    focus_border_color: Option<rgpui::Hsla>,
    text_color: Option<rgpui::Hsla>,
) -> InputStyle {
    let bg = if disabled {
...
pub struct ActionStyle {
    ...
    pub hover_bg: rgpui::Hsla,
    /// The foreground/text color.
    pub fg: rgpui::Hsla,
    /// The disabled background color.
    pub disabled_bg: rgpui::Hsla,
    /// The disabled foreground/text color.
    pub disabled_fg: rgpui::Hsla,
}
...
pub fn compute_action_style(
    ...
    disabled: bool,
    custom_bg: Option<rgpui::Hsla>,
    custom_hover_bg: Option<rgpui::Hsla>,
) -> ActionStyle {
...
pub fn compute_toggle_style(
    ...
    checked: bool,
    disabled: bool,
    custom_accent: Option<rgpui::Hsla>,
) -> ToggleStyle {
