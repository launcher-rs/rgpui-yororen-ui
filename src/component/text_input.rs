...
use rgpui::{
    ...
    Style, Styled, TextAlign, TextRun, UTF16Selection, UnderlineStyle, actions, div, fill, point,
...
pub(crate) fn init(cx: &mut App) {
    cx.bind_keys([
        rgpui::KeyBinding::new("backspace", Backspace, Some("UITextInput")),
        rgpui::KeyBinding::new("delete", Delete, Some("UITextInput")),
        rgpui::KeyBinding::new("enter", Enter, Some("UITextInput")),
        rgpui::KeyBinding::new("left", Left, Some("UITextInput")),
        rgpui::KeyBinding::new("right", Right, Some("UITextInput")),
        rgpui::KeyBinding::new("shift-left", SelectLeft, Some("UITextInput")),
        rgpui::KeyBinding::new("shift-right", SelectRight, Some("UITextInput")),
        rgpui::KeyBinding::new("secondary-a", SelectAll, Some("UITextInput")),
        rgpui::KeyBinding::new("secondary-v", Paste, Some("UITextInput")),
        rgpui::KeyBinding::new("secondary-c", Copy, Some("UITextInput")),
        rgpui::KeyBinding::new("secondary-x", Cut, Some("UITextInput")),
        rgpui::KeyBinding::new("home", Home, Some("UITextInput")),
        rgpui::KeyBinding::new("end", End, Some("UITextInput")),
...
pub struct TextInputState {
    ...
    focus_subscription: Option<rgpui::Subscription>,
}
...
impl TextInputState {
    ...
    fn reset_cursor_blink(&mut self, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.show_cursor(cx);
    ...
    fn focus_in(&mut self, window: &mut rgpui::Window, cx: &mut Context<Self>) {
    ...
    fn left(&mut self, _: &Left, window: &mut rgpui::Window, cx: &mut Context<Self>) {
    ...
    fn right(&mut self, _: &Right, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        if self.edit.selected_range().is_empty() {
            self.move_to(
    ...
    fn select_left(&mut self, _: &SelectLeft, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.select_to(
            self.edit.previous_boundary(self.edit.cursor_offset()),
            window,
            cx,
    ...
    fn select_all(&mut self, _: &SelectAll, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.move_to(0, window, cx);
        self.select_to(self.edit.content().len(), window, cx)
    }

    fn home(&mut self, _: &Home, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.move_to(0, window, cx);
    }

    fn end(&mut self, _: &End, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.move_to(self.edit.content().len(), window, cx);
    }

    fn backspace(&mut self, _: &Backspace, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        if self.edit.selected_range().is_empty() {
            self.select_to(
                self.edit.previous_boundary(self.edit.cursor_offset()),
                window,
    ...
    fn delete(&mut self, _: &Delete, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        if self.edit.selected_range().is_empty() {
            self.select_to(
                self.edit.next_boundary(self.edit.cursor_offset()),
                window,
    ...
    fn paste(&mut self, _: &Paste, window: &mut rgpui::Window, cx: &mut Context<Self>) {
    ...
    fn copy(&mut self, _: &Copy, _: &mut rgpui::Window, cx: &mut Context<Self>) {
        if !self.edit.selected_range().is_empty() {
            cx.write_to_clipboard(rgpui::ClipboardItem::new_string(
                self.edit.content()[self.edit.selected_range().clone()].to_string(),
            ));
        }
    }

    fn cut(&mut self, _: &Cut, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        if !self.edit.selected_range().is_empty() {
            cx.write_to_clipboard(rgpui::ClipboardItem::new_string(
                self.edit.content()[self.edit.selected_range().clone()].to_string(),
            ));
    ...
    fn move_to(&mut self, offset: usize, window: &mut rgpui::Window, cx: &mut Context<Self>) {
    ...
    fn select_to(&mut self, offset: usize, window: &mut rgpui::Window, cx: &mut Context<Self>) {
        self.reset_cursor_blink(window, cx);
...
impl RenderOnce for TextInputState {
    fn render(self, _window: &mut rgpui::Window, _cx: &mut App) -> impl IntoElement {
...
impl EntityInputHandler for TextInputState {
    ...
    fn unmark_text(&mut self, _window: &mut rgpui::Window, _cx: &mut Context<Self>) {
...
pub struct TextInput {
    ...
    height: Option<rgpui::AbsoluteLength>,
...
impl TextInput {
    ...
    where
        F: 'static + Fn(SharedString, &mut rgpui::Window, &mut App),
    {
    ...
    pub fn height(mut self, height: rgpui::AbsoluteLength) -> Self {
...
impl RenderOnce for TextInput {
    fn render(self, window: &mut rgpui::Window, cx: &mut App) -> impl IntoElement {
