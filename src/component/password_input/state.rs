...
pub type PasswordInputHandler = Arc<dyn Fn(SharedString, &mut rgpui::Window, &mut App)>;
...
impl rgpui::RenderOnce for PasswordInputState {
    fn render(self, _window: &mut rgpui::Window, _cx: &mut App) -> impl rgpui::IntoElement {
        rgpui::div().child(self.content)
    }
}

impl rgpui::EntityInputHandler for PasswordInputState {
    fn text_for_range(
        &mut self,
    ...
    fn bounds_for_range(
        ...
        Some(rgpui::Bounds::from_corners(
            rgpui::point(
